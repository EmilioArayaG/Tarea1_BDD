...
Nicolas Muñoz 202473637-K

Instruciones para el correcto funcionamiento del programa:
-Primero para aclarar nosotros el IDLE de DataGrip, dentro de este con MySql como fue requerido en la tarea.

1.Inicializamos la base de datos localmente en la terminal
